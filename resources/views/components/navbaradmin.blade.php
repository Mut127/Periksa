<nav style="background-color: #E4C4E2;" x-data="{ isOpen: false }">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <img class="h-4 w-20" src="../image/periksa.png" alt="periksa">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <x-nav-link href="pengaduan" :active="request()->is('pengaduan')">Pengaduan</x-nav-link>
                        <x-nav-link href="kritiksaran" :active="request()->is('kritiksaran')">Kritik dan Saran</x-nav-link>
                        <x-nav-link href="akun" :active="request()->is('akun')">Akun</x-nav-link>
